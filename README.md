An Elearning Platform built using the MERN (MongoDB, Express.js, React.js, Node.js) stack. It facilitates online courses, user management, and instructor-student communication.
